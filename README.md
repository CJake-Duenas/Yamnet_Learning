...
2. On the terminal, type 'python -m venv venv'. This will initialize a virtual environment
3. After that, type 'venv/Scripts/activate'. This will toggle the virtual environment on.
